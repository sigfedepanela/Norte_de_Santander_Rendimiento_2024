...
var style_Departamento_Norte_de_Santander_1 = function(feature, resolution){
    ...
    var labelText = ""; 
    var value = feature.get("9.Norte_de_Santander-Norte de Santander_Rendimiento_(ton/ha)");
    ...
    if (value >= 0.000000 && value <= 0.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.000000 && value <= 1.051244) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 1.051244 && value <= 2.102487) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2.102487 && value <= 3.153731) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 3.153731 && value <= 4.204974) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 4.204974 && value <= 5.256218) {
            style = [ new ol.style.Style({
